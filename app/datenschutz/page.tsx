      ...
      <div className="max-w-3xl mx-auto">
        ...
        <section className="space-y-8 text-gray-300">
          ...
          <div>
            ...
            <p className="mb-3">
              Beim Besuch unserer Website werden durch den Webserver unseres Hosting-Providers (All-Inkl) automatisch folgende Daten erhoben:
            </p>
          ...
          <div>
            ...
            <p>
              Diese Website wird bei All-Inkl gehostet. Details zum Datenschutz bei All-Inkl finden Sie unter: 
              <a href="https://all-inkl.com/datenschutz/" className="text-[#92c43f] hover:underline ml-1" target="_blank" rel="noopener noreferrer">
